...
function buildCampaign(rep, meta, cls) {
  ...
  return {
    ...
    // Mailchimp reporta la venta atribuida en USD (currency_code=USD). Usamos
    // total_spent tal cual (lo que efectivamente gastó el comprador). SIN convertir.
...
export const getDashboard = unstable_cache(
  computeDashboard,
  ["cava-email-dashboard-v3"], // subir versión invalida la caché tras cambios de lógica
